    ...
    <div className="min-h-screen bg-[#f5f0e6] text-[#4b2f23] pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-3 p-5 rounded-3xl bg-[#ede3d1] border border-[#aa7b3f]/30 shadow-2xl space-y-4 max-h-[580px] flex flex-col">
            <div>
              <h3 className="text-xs font-bold text-[#b65a3a] uppercase tracking-wider">Heritage Sites</h3>
              <p className="text-[10px] text-[#4b2f23]/60 mt-0.5">Select a monument to focus the map</p>
            </div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-[#f5f0e6] border border-[#aa7b3f]/30 rounded-xl pl-9 pr-3 py-2 text-xs text-[#4b2f23] placeholder-[#F3EBDD]/35 focus:outline-none focus:border-[#aa7b3f] transition-all"
              />
                    ...
                    <button
                      ...
                      className={`w-full text-left p-3 rounded-xl border text-xs transition-all flex items-start gap-2.5 ${
                        isSelected
                          ...
                          : 'bg-[#f5f0e6]/45 text-[#4b2f23]/80 border-[#aa7b3f]/15 hover:border-[#aa7b3f]/55 hover:bg-[#f5f0e6]/80'
                      }`}
                    >
                      <MapPin className={`w-3.5 h-3.5 shrink-0 mt-0.5 ${isSelected ? 'text-white' : 'text-[#b65a3a]'}`} />
                      <div className="truncate">
                        <div className="font-semibold truncate">{mon.name}</div>
                        <div className={`text-[10px] mt-0.5 truncate ${isSelected ? 'text-white/70' : 'text-[#4b2f23]/50'}`}>
          ...
          <div className="lg:col-span-6 relative rounded-3xl bg-[#ede3d1] border border-[#aa7b3f]/40 overflow-hidden shadow-2xl min-h-[580px] flex flex-col justify-between p-6 space-y-4">
            ...
            <div className="flex items-center justify-between text-xs text-[#4b2f23]/60 pt-2 border-t border-[#aa7b3f]/20">
              ...
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-[#b65a3a] uppercase font-bold">WGS-84 Survey Datum</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="p-6 rounded-3xl bg-[#ede3d1] border border-[#aa7b3f]/40 shadow-2xl space-y-4">
              <div className="flex items-center justify-between pb-3 border-b border-[#aa7b3f]/20">
                <span className="px-2.5 py-0.5 rounded-full bg-[#b65a3a]/20 text-[#b65a3a] text-[10px] uppercase font-bold tracking-wider">
                  Selected Landmark
                </span>
                <span className="text-xs font-mono text-[#4b2f23]/60">{selectedMonument.period}</span>
              </div>

              <div className="relative h-44 rounded-2xl overflow-hidden border border-[#aa7b3f]/30">
                <img
                ...
                <div className="absolute bottom-3 left-3 right-3">
                  <h3 className="font-display text-lg font-bold text-[#4b2f23] truncate">
                    {selectedMonument.name}
                  </h3>
                  <p className="text-[11px] text-[#b65a3a] font-subheading italic truncate">
                    {selectedMonument.tagline}
                  </p>
                </div>
              </div>

              <div className="space-y-2 text-xs text-[#4b2f23]/80">
                <p className="line-clamp-3 leading-relaxed">
                  {selectedMonument.culturalSignificance}
                </p>
                <div className="p-3 rounded-xl bg-[#f5f0e6] border border-[#aa7b3f]/20 space-y-1">
                  <div className="text-[10px] font-bold text-[#b65a3a] uppercase">Dynasty & Architecture</div>
                  <div className="text-xs font-semibold text-[#4b2f23]">{selectedMonument.dynasty} • {selectedMonument.architectureStyle}</div>
                </div>
              </div>
              ...
              <div className="pt-2 flex flex-col gap-2">
                <button
                  ...
                  className="w-full py-2.5 rounded-xl bg-[#f5f0e6] border border-[#aa7b3f]/40 text-[#4b2f23] text-xs font-bold uppercase tracking-wider hover:border-[#aa7b3f] hover:bg-[#ede3d1] transition-all flex items-center justify-center gap-2"
                >
                ...
                {selectedMonument.has3DModel && (
                  <button
                    ...
                    className="w-full py-2.5 rounded-xl bg-[#b65a3a] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#f5f0e6] transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#D4A85A]/20"
                  >
            ...
            <div className="p-5 rounded-2xl bg-[#f5f0e6] border border-[#aa7b3f]/30 space-y-2">
              ...
              <button
                ...
                className="w-full mt-2 py-2 rounded-xl bg-[#ede3d1] border border-[#aa7b3f]/50 text-xs font-bold text-[#b65a3a] hover:bg-[#b65a3a] hover:text-white transition-colors flex items-center justify-center gap-1.5"
              >
