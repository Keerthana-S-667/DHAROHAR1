    ...
    <div className="min-h-screen bg-[#f5f0e6] text-[#4b2f23] pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-2 text-xs text-[#b65a3a]">
          ...
          <span className="text-[#4b2f23] font-bold">Traveller Home</span>
        </div>

        {/* Cinematic Header Block */}
        <div className="p-8 sm:p-12 rounded-3xl bg-[#ede3d1] border border-[#aa7b3f]/40 shadow-2xl relative overflow-hidden text-center space-y-6">
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#b65a3a]/5 rounded-full blur-3xl pointer-events-none" />
          
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#f5f0e6] border border-[#aa7b3f]/30 text-[10px] text-[#b65a3a] font-semibold uppercase tracking-widest">
          ...
          {status === 'idle' && (
            <div className="space-y-6 animate-in fade-in duration-300">
              <div className="space-y-2">
                ...
                <p className="text-xs sm:text-sm text-[#4b2f23]/70 max-w-lg mx-auto leading-relaxed pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md mx-auto pt-2">
                ...
                <button
                  ...
                  className="py-4 px-6 rounded-xl bg-[#b65a3a] text-white font-bold text-xs uppercase tracking-wider hover:bg-[#f5f0e6] transition-colors flex items-center justify-center gap-2 shadow-lg shadow-[#D4A85A]/15 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="py-4 px-6 rounded-xl bg-[#ede3d1] border border-[#aa7b3f]/50 text-[#4b2f23] font-semibold text-xs uppercase tracking-wider hover:border-[#aa7b3f] hover:bg-[#B58A52]/20 transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
                  <Search className="w-4 h-4 text-[#b65a3a]" />
          ...
          {status === 'loading' && (
            <div className="space-y-4 py-8 animate-in fade-in duration-300">
              <div className="w-12 h-12 rounded-full border-2 border-[#aa7b3f]/20 border-t-[#D4A85A] animate-spin mx-auto" />
              <p className="font-subheading text-lg text-[#b65a3a] italic">
          ...
          {status === 'success' && (
            <div className="space-y-6 py-4 animate-in fade-in duration-300">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-[#b65a3a]/20 border border-[#aa7b3f] text-[#b65a3a] mx-auto">
              ...
              <div className="space-y-2">
                ...
                {userLocation && (
                  <div className="p-3 rounded-xl bg-[#f5f0e6] border border-[#aa7b3f]/30 max-w-xs mx-auto text-xs text-[#b65a3a] font-mono tracking-wider">
                    {userLocation.latitude.toFixed(6)}° N, {userLocation.longitude.toFixed(6)}° E
                  </div>
                )}
              </div>
              <p className="text-xs text-[#4b2f23]/70 max-w-md mx-auto leading-relaxed">
          ...
          {status === 'denied' && (
            <div className="space-y-5 py-4 animate-in fade-in duration-300">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md mx-auto pt-2">
                <button
                  onClick={handleRequestLocation}
                  className="w-full sm:w-auto py-3 px-6 rounded-xl bg-[#b65a3a] text-white font-bold text-xs uppercase tracking-wider hover:bg-[#f5f0e6] transition-colors cursor-pointer"
                >
                  Try Again
                </button>
                <button
                  onClick={() => onNavigate('traveller/search')}
                  className="w-full sm:w-auto py-3 px-6 rounded-xl bg-[#ede3d1] border border-[#aa7b3f]/50 text-[#4b2f23] font-semibold text-xs uppercase tracking-wider hover:border-[#aa7b3f] hover:bg-[#B58A52]/20 transition-all cursor-pointer"
                >
        ...
        <div className="p-6 rounded-2xl bg-[#ede3d1]/40 border border-[#aa7b3f]/20 flex items-center gap-4 text-xs text-[#4b2f23]/80">
          <ShieldCheck className="w-6 h-6 text-[#b65a3a] shrink-0" />
          <div className="leading-relaxed">
            <span className="text-[#b65a3a] font-bold">Stewardship Status:</span> Active GPS cartography database mapped for 5 key states. Turn on your location permission inside browser settings to reveal nearby sites.
          </div>
        </div>
      </div>
    </div>
